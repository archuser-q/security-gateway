...
export const RouteAddForm = (props: Props) => {
  ...
  // Không nhét user_id/created_by vào body gửi lên APISIX Admin API -
  // 2 field này không có trong schema Route chuẩn của APISIX, và
  // auth.user ở đây đang là dev-bypass cố định (xem comment trong
  // AuthContext.tsx), nên trước đó MỌI route tạo ra đều bị gắn nhầm
  // "created_by: dev" bất kể ai thực sự tạo - vừa sai dữ liệu, vừa có
  // thể bị Admin API từ chối khi APISIX bật additionalProperties: false.
  // Nếu sau này cần audit log thật, nên gọi 1 API riêng của backend
  // (không phải Admin API của APISIX) trong onSuccess bên dưới, thay vì
  // gộp chung vào payload route.
